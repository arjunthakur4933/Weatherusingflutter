...
import 'package:weather/ui/home/weather_details_widget.dart';
                ...
                Row(children: [
                  Expanded(
                    child: _WeatherItemDetails(
                      title: 'Viento',
                      value: "${weather.windSpeed.toStringAsFixed(2)} mph", key: null,
                    ),
                  ),
                  Expanded(
                    child: _WeatherItemDetails(
                      title: 'Presión de aire',
                      value: '${weather.airPressure.toStringAsFixed(2)} mbar', key: null,
                    ),
                  ),
                  Expanded(
                    child: _WeatherItemDetails(
                      title: 'Humedad',
                      value: '${weather.humidity}%', key: null,
                    ),
                  ),
                ]),
                const SizedBox(
